...
def get_pseudo_op_mappings():
    ...
    pseudo_op_mappings = {
        ...
        ## Disabling perf model for paged decode as it is included in the unified attention
        # "aiter::paged_attention_v1": attention_perf_model_extensions.aiter_paged_attention_v1,
