...
def main():
    ...
    parser.add_argument("--dtype", type=str, required=True, help="Data type (e.g., fp16, fp32)")
    ...
    #parser.add_argument("--dtype_A_B", type=str, default="float", help="Input dtype for SDPA")
    parser.add_argument("--bytes", type=int, default=0, help="Total bytes moved (optional for SDPA)")
    ...
    if args.op == "gemm":
        ...
        if args.backward:
            ...
            time = SDPA.get_simulation_time_bwd_func(
                ...
                dtype_A_B=dtype_A_B, bytes=args.bytes,
