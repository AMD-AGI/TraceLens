...
from TraceLens.Visualizer.model_explorer_export.build import build_model_explorer_payload
...
def test_inject_group_inputs_labels_external_tensor_ports_on_edges():
    from TraceLens.Visualizer.model_explorer_export.merge import _inject_group_inputs
...
def test_replace_tile_with_group_puts_nested_diagram_in_the_tile_slot():
    from TraceLens.Visualizer.model_explorer_export.merge import _replace_tile_with_group
...
def test_mirror_boundary_inputs_exposes_multi_input_ports_in_parent():
    from TraceLens.Visualizer.model_explorer_export.merge import _mirror_boundary_inputs
...
def test_default_html_output_path_replaces_slashes():
    from TraceLens.Visualizer.model_explorer_export.cli import default_html_output_path
...
def test_implicit_cli_output_uses_html_default(
    ...
    from TraceLens.Visualizer.model_explorer_export.cli import main
...
def test_viewer_url_uses_root_path():
    from TraceLens.Visualizer.model_explorer_export.serve import viewer_url
...
def test_compose_viewer_html_embeds_payload_without_external_json():
    from TraceLens.Visualizer.model_explorer_export.viewer_page import compose_viewer_html
...
def test_kernel_frame_labels_split_l2norm_q_and_k_and_sanitize_unicode():
    from TraceLens.Visualizer.model_explorer_export.labels import apply_kernel_frame_labels
...
def test_fill_missing_node_shapes_seeds_and_propagates():
    from TraceLens.ModelUtils.shape_inference import ShapeContext

    from TraceLens.Visualizer.model_explorer_export.shapes import fill_missing_node_shapes
...
def test_group_boundary_shapes_reads_the_crossing_tensor():
    from TraceLens.Visualizer.model_explorer_export.shapes import group_boundary_shapes
