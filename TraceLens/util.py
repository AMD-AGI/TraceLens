...
class TraceEventUtils:
    ...
    class JaxOpKeys:
        ...
        FABwdKeys = ["FmhaBwd", "flash_bprop", "ck_fused_attn::dk_dv_reduce_thd", "_ZN5aiter24fmha_fwd_hd128_bf16_rtnaE.kd"]
        FAFwdKeys = ["FmhaFwd", "flash_fprop", "_ZN5aiter28fmha_bwd_hd128_bf16_a16_rtnaE.kd"]
