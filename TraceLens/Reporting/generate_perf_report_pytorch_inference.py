...
def generate_perf_report_pytorch(
    ...
    perf_analyzer.tree.apply_annotation(name_filters=["vllm::unified_attention_with_output","aiter::mha_varlen_fwd","pseudo_mla_decode_fwd","sglang_profiler::tilelang_kernel_tilelang_sparse_fwd_586"])
