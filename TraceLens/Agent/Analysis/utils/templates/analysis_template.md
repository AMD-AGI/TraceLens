...
<!-- Trace 1 ms = operations[i].time_ms. Trace 2 ms = operations[i].efficiency.t2_time_ms.
     Count T1/T2 = operations[i].count / operations[i].count_trace2 when present.
     Difference (ms) = operations[i].efficiency.difference_ms (negative ⇒ Trace 1 slower), or —. -->
