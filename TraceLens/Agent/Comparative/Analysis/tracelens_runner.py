...
class TraceLensRunner:
    ...
    def run_critical_path_analysis(
        self, kineto: str, et: str, output_dir: Path, gpu_name: str
    ) -> Tuple[Path, Path]:
        """
    ...
    def generate_tracelens_report(
        ...
        try:
            ...
            use_extension = (
                self.use_critical_path and extension_path and extension_path.exists()
            )
            ...
            if self.use_critical_path and "critical_path_summary" in result_dfs:
                ...
                if (
                    not cp_summary.empty
                    and "critical_path_percentage" in cp_summary.columns
                ):
    ...
    def generate_comparison_report(
        self,
        gpu1_report_path: Path,
        gpu2_report_path: Path,
        output_dir: Path,
        gpu1_name: str,
        gpu2_name: str,
    ) -> bool:
