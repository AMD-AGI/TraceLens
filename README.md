...
> **Capturing a trace?** See [Collect a trace](docs/how-to/generate-perf-report-pytorch.md#collect-a-trace) for the profiler flags that matter, and [inference collection](docs/how-to/generate-perf-report-pytorch-inference.md) for the graph-capture path.
