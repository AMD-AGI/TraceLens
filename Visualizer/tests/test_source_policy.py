...
from visualizer.github import fetch_github_source, parse_github_url
from visualizer.source import resolve_github_files
...
def test_fetch_github_source_allows_whitelisted_repo(monkeypatch, tmp_path: Path):
    ...
    monkeypatch.setattr("visualizer.github._fetch_archive", fake_fetch_archive)
